...
public class PostServiceTest {
    ...
    @Test
    void postCreateOK() {   //포스트작성이_성공한경우
        String title = "title";
        String body = "body";
    ...
    @Test
    void postCreateNoExistsUser() { //포스트작성시_요청한유저가_존재하지않는경우
        String title = "title";
        String body = "body";
        String userName = "userName";
    ...
    @Test
    void postUpdateOK() {  //포스트수정이_성공한경우
        String title = "title";
        String body = "body";
        String userName = "userName";
        Integer postId = 1;
    ...
    @Test
    void postUpdateNoExistPost() { //포스트수정시_포스트가_존재하지않는_경우
        String title = "title";
        String body = "body";
        String userName = "userName";
        Integer postId = 1;
    ...
    @Test
    void postUpdateNoAuth() {  //포스트수정시_권한이_없는_경우
        String title = "title";
        String body = "body";
        String userName = "userName";
        Integer postId = 1;
    ...
    @Test
    void postDeleteOK() {  //포스트삭제가_성공한경우
        String userName = "userName";
        Integer postId = 1;
    ...
    @Test
    void postDeleteNoExistPost() { //포스트삭제시_포스트가_존재하지않는_경우
        String userName = "userName";
        Integer postId = 1;
    ...
    @Test
    void postDeleteNoAuth() { //포스트삭제시_권한이_없는_경우
        String userName = "userName";
        Integer postId = 1;
    ...
    @Test
    void myListFeedOK() {  //내피드목록요청이_성공한경우
        Pageable pageable = mock(Pageable.class);
