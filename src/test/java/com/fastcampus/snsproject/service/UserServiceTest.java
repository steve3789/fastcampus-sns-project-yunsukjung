...
public class UserServiceTest {
    ...
    @Test
    void memberRegisterOK() {   //회원가입이_정상적으로_동작하는_경우
    ...
    @Test
    void alreadyMemberOnRegister() {  //회원가입시_userName으로_회원가입한_유저가_이미_있는경우
        String userName = "userName";
        String password = "password";
    ...
    @Test
    void loginOK() { //로그인이_정상적으로_동작하는_경우
        String userName = "userName";
        String password = "password";
    ...
    @Test
    void loginNNoMember() { //로그인시_userName으로_회원가입한_유저가_없는_경우
        String userName = "userName";
        String password = "password";
    ...
    @Test
    void wrongPWLogin() { //로그인시_패스워드가_틀린_경우
        String userName = "userName";
        String password = "password";
